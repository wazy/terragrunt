...
// TestPrivateRegistrySubDomainWithConfgFileToken verifies that a credentials block configured for a parent
...
func TestPrivateRegistrySubDomainWithConfgFileToken(t *testing.T) {
	rootPath, host, token := setupPrivateRegistryTest(t)
